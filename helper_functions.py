...
# Mock blockchain functions for development/testing
def mock_blockchain_verification(serial_number):
    """Mock function for testing when blockchain is not available"""
    # Simulate blockchain verification for known test serials
    blockchain_products = [
        "APPLE001", "NIKE001", "GUCCI001", "ROLEX001", "SAMSUNG001",
        "ADIDAS001", "CHANEL001", "APPLE002", "VERSACE001", "PRADA001",
        "SONY001", "BALENCIAGA001", "HERMES001", "TESLA001", "DIOR001",
        "OMEGA001", "BURBERRY001", "CARTIER001", "BOSE001", "YEEZY001"
    ]
    
    if serial_number in blockchain_products:
        return {
            "manufacturer": "0x742d35Cc6634C0532925a3b8D400AD96Cfb4c001",
            "name": f"Mock {serial_number} Product",
